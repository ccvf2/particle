			...
			<nav class="navbar navbar-default mCustomScrollbar" role="navigation" data-mcs-theme="minimal-dark">
				...
				<div class="collapse navbar-collapse navbar-responsive-collapse">
					<div class="menu-container">
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu">
									...
									<li class="dropdown-submenu">
										<a href="javascript:void(0);" data-toggle="dropdown">Option 2: </a>
										<ul class="dropdown-menu">
											<li><a href="#">SUB_Option 1: </a></li>
											<li><a target="_blank" href="#">SUB_Option 2: </a></li>
										</ul>
									</li>
									<!-- End One Page -->
						...
						<p class="copyright-text">&copy; 2015 Unify. All Rights Reserved. System Design by SEONGGOOK, SEONGUK</p>
					</div>
				</div>
				<!-- End Navbar Collapse -->
			</nav>
